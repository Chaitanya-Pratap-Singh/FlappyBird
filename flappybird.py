...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'files/bird.png'
BACKGROUND = 'files/background.png'
PIPE = 'files/pipe.png'
icon =  pygame.image.load("files/bird.png")
def welcomeScreen():
    """
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('files/message.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('files/base.png').convert_alpha()
    GAME_SPRITES['pipe'] =(pygame.transform.rotate(pygame.image.load( PIPE).convert_alpha(), 180), 
    pygame.image.load(PIPE).convert_alpha()
    )

    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('files/die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('files/hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('files/point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('files/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('files/wing.wav')
